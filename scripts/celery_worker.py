...
# Now import and run the Celery app
...
if __name__ == "__main__":
    ...
    sys.argv = [
        "celery",
        "-A", "codestory.ingestion_pipeline.celery_app:app",
        "worker",
        "-l", "debug",  # Increased log level for debugging
        "-Q", "ingestion",
    ...
    # celery -A codestory.ingestion_pipeline.celery_app:app worker -l debug -Q ingestion --concurrency=1 --loglevel=DEBUG
