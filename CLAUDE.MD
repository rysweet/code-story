...
# Prompt History and Shell History - MANDATORY REQUIREMENTS

⚠️ CRITICAL REQUIREMENT: You MUST maintain BOTH history files described below. Update them BEFORE responding to any user message!
...
- Update the file AFTER EVERY USER INTERACTION but BEFORE responding to the user
...
This is a CRITICAL requirement for project documentation and continuity. YOU MUST NEVER FAIL to maintain this file.
...
- Update this file AFTER EVERY SHELL COMMAND you run successfully
...
Make updating these files your FIRST priority after each user interaction or command execution.
```
