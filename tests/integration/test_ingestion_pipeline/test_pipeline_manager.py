...
class TestPipelineManager:
    ...
    def _run_pipeline(self: Any) -> None:
    ...
    def _get_step_instance(self: Any, step_name: str) -> PipelineStep | None:
    ...
    def get_job_status(self: Any, job_id: str) -> dict[str, Any]:
    ...
    def stop_job(self: Any, job_id: str) -> bool:
        """Stop a running job.
    ...
    @property
    def _registered_steps(self: Any) -> list[type[PipelineStep]]:
