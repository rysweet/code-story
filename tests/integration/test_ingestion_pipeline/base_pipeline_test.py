...
class BasePipelineTest:
    ...
    def setup_test_env(
        self: Any, neo4j_connector: Any, redis_client: Any, celery_app: Any
    ) -> None:
    ...
    def wait_for_node_in_db(
        self: Any, query: Any, params: Any = None, timeout: Any = 15
    ) -> Any:
    ...
    def create_filesystem_nodes(self: Any) -> None:
        ...
        self.neo4j_connector.execute_query(
            dir_query,
            params={"repo_path": self.repo_dir, "name": "src", "path": "src"},
            write=True,
        )
        subdir_query = "\n        MATCH (parent:Directory {path: $parent_path})\n        CREATE (d:Directory {name: $name, path: $path})\n        CREATE (parent)-[:CONTAINS]->(d)\n        RETURN d\n        "
        self.neo4j_connector.execute_query(
            subdir_query,
            params={"parent_path": "src", "name": "package", "path": "src/package"},
            write=True,
        )
