...
def test_pipeline_manager_run(
    sample_repo: Any, neo4j_connector: Any, test_config: Any
) -> None:
...
@pytest.mark.integration
def test_pipeline_manager_stop(
    sample_repo: Any, neo4j_connector: Any, test_config: Any
) -> None:
...
@pytest.mark.integration
def test_pipeline_manager_run_single_step(
    sample_repo: Any, neo4j_connector: Any, test_config: Any
) -> None:
