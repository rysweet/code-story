...
class TestRetryFunctions:
    ...
    def test_before_retry_callback(self):
        ...
        retry_state.kwargs = {
            "_operation_type": OperationType.CHAT,
            "model": "gpt-4o"
        }
        ...
        with patch("src.codestory.llm.backoff.record_retry") as mock_record:
...
class TestRetryDecorators:
    ...
    def test_retry_on_openai_errors(self):
        ...
        with patch("src.codestory.llm.backoff.retry") as mock_retry:
