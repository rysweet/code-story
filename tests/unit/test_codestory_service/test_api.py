...
class TestGraphAPI:
    ...
    @pytest.mark.asyncio
    async def test_execute_cypher_query_write_permission(
        self: Any, mock_service: Any
    ) -> None:
...
class TestVisualizationAPI:
    ...
    async def test_generate_visualization(
        self: Any, mock_request: Any, mock_graph_service: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_generate_visualization_error(
        self: Any, mock_request: Any, mock_graph_service: Any
    ) -> None:
...
class TestHealthAPI:
    ...
    async def test_health_check_all_healthy(
        self: Any, mock_adapters: Any, monkeypatch: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_health_check_one_degraded(
        self: Any, mock_adapters: Any, monkeypatch: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_health_check_with_auto_fix(
        self: Any, mock_adapters: Any, monkeypatch: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_health_check_with_auto_fix_failure(
        self: Any, mock_adapters: Any, monkeypatch: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_health_check_with_auto_fix_timeout(
        self: Any, mock_adapters: Any, monkeypatch: Any
    ) -> None:
