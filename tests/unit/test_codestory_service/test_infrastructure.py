...
class TestNeo4jAdapter:
    ...
    async def test_health_check_healthy(
        self: Any, adapter: Any, mock_connector: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execute_cypher_query_success(
        self: Any, adapter: Any, mock_connector: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execute_cypher_query_error(
        self: Any, adapter: Any, mock_connector: Any
    ) -> None:
...
class TestOpenAIAdapter:
    ...
    async def test_health_check_azure_auth_error(self: Any, mock_client: Any) -> None:
        ...
        azure_error = Exception(
            "DefaultAzureCredential failed to retrieve a token from the included credentials. DefaultAzureCredential failed to retrieve a token from the included credentials. AzureCliCredential authentication failed: Azure CLI not found on the system PATH."
        )
    ...
    @pytest.mark.asyncio
    async def test_health_check_azure_auth_error_with_tenant(
        self: Any, mock_client: Any
    ) -> None:
        """Test health check extracts tenant ID from Azure authentication errors."""
        azure_error = Exception(
            "DefaultAzureCredential failed to retrieve a token from the included credentials. DefaultAzureCredential authentication failed for tenant '12345678-1234-1234-1234-123456789012'. AzureCliCredential authentication failed: AADSTS700003."
        )
    ...
    @pytest.mark.asyncio
    async def test_create_embeddings_error(
        self: Any, adapter: Any, mock_client: Any
    ) -> None:
