...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_login_prod_mode(
        self: Any, service: Any, mock_validator: Any
    ) -> None:
...
class TestGraphService:
    ...
    async def test_execute_cypher_query(
        self: Any, service: Any, mock_neo4j: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_execute_vector_search(
        self: Any, service: Any, mock_neo4j: Any, mock_openai: Any
    ) -> None:
