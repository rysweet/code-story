...
class TestVisualizeCommands:
    ...
    def test_visualize_generate(
        self: Any, cli_runner: CliRunner, mock_service_client: MagicMock
    ) -> None:
        """Test 'visualize generate' command."""
        mock_service_client.generate_visualization.return_value = (
            "<html><body>Test visualization</body></html>"
        )
    ...
    def test_visualize_generate_with_options(
        self: Any, cli_runner: CliRunner, mock_service_client: MagicMock
    ) -> None:
    ...
    def test_visualize_service_auto_start(
        self: Any, cli_runner: CliRunner, mock_service_client: MagicMock
    ) -> None:
