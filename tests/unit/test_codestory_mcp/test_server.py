...
@pytest.mark.asyncio
async def test_get_current_user_with_auth_disabled(
    mock_settings: Any, mock_metrics: Any
) -> None:
...
@pytest.mark.asyncio
async def test_get_current_user_without_auth_header(
    mock_settings: Any, mock_metrics: Any
) -> None:
...
async def test_get_current_user_with_valid_token(
    mock_settings: Any, mock_metrics: Any, mock_entra_validator: Any
) -> None:
...
@pytest.mark.asyncio
async def test_tool_executor_validation_error(
    mock_metrics: Any, mock_tool: Any
) -> None:
...
@pytest.mark.asyncio
async def test_tool_executor_unexpected_error(
    mock_metrics: Any, mock_tool: Any
) -> None:
