...
class TestGraphServiceAdapter:
    ...
    @pytest.fixture
    def adapter(
        self: Any, mock_settings: Any, mock_metrics: Any, mock_client: Any
    ) -> Any:
    ...
    async def test_search_success(self: Any, adapter: Any, mock_client: Any) -> None:
            ...
            "data": [
                {
                    "id": "node-123",
                    "type": "Class",
                    "properties": {"name": "TestClass", "path": "/path/to/test.py"},
                    "score": 0.95,
                },
                {
                    "id": "node-456",
        ...
        mock_client.post.assert_called_once_with(
            "/v1/query/search",
            json={"query": "test", "node_types": ["Class", "Function"], "limit": 10},
        )
    ...
    async def test_search_error(
        self: Any, adapter: Any, mock_client: Any, mock_metrics: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_find_node_not_found(
        self: Any, adapter: Any, mock_client: Any, mock_metrics: Any
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_find_paths_success(
        ...
        mock_client.post.assert_called_once_with(
            "/v1/query/paths",
            json={"from_id": "node-123", "to_id": "node-456", "max_paths": 3},
        )
        assert len(paths) == 1
...
class TestOpenAIServiceAdapter:
    ...
    async def test_generate_path_explanation_success(
        ...
        path_elements = [
            ...
            {"element_type": "relationship", "id": "rel-123", "type": "CALLS"},
            {
                "element_type": "node",
                "id": "node-456",
                "type": "Method",
        ...
        explanation = await adapter.generate_path_explanation(
            path_elements=path_elements, max_tokens=300
        )
        mock_client.create_chat_completion.assert_called_once()
        request = mock_client.create_chat_completion.call_args[0][0]
    ...
    @pytest.mark.asyncio
    async def test_find_similar_code_success(
        self: Any, adapter: Any, mock_client: Any, mock_metrics: Any
    ) -> None:
