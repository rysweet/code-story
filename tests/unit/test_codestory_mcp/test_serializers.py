...
class TestNodeSerializer:
    ...
    def test_to_mcp_result_with_nodes(self, mock_node: Any):
    ...
    def test_to_mcp_result_with_scored_nodes(self, mock_node: Any):
