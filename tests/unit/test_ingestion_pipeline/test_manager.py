...
class TestPipelineManager:
    ...
    def test_init(self, config_file):
        ...
        with patch("src.codestory.ingestion_pipeline.manager.discover_pipeline_steps") as mock_discover:
    ...
    def test_get_step_class_not_found(self, config_file):
        ...
        with patch("src.codestory.ingestion_pipeline.manager.discover_pipeline_steps") as mock_discover:
            ...
            with patch("src.codestory.ingestion_pipeline.manager.find_step_manually") as mock_find:
    ...
    def test_start_job(self, config_file, mock_step_class):
        ...
        with patch("src.codestory.ingestion_pipeline.manager.discover_pipeline_steps") as mock_discover:
            ...
            with patch("uuid.uuid4") as mock_uuid:
                ...
                with patch("src.codestory.ingestion_pipeline.manager.orchestrate_pipeline") as mock_task:
    ...
    def test_status(self, config_file, mock_step_class):
        ...
        with patch("src.codestory.ingestion_pipeline.manager.discover_pipeline_steps") as mock_discover:
            ...
            with patch("src.codestory.ingestion_pipeline.manager.get_job_status") as mock_task:
                mock_result = MagicMock()
    ...
    def test_stop(self, config_file, mock_step_class):
        ...
        with patch("src.codestory.ingestion_pipeline.manager.discover_pipeline_steps") as mock_discover:
            ...
            # Mock stop_job task
            with patch("src.codestory.ingestion_pipeline.manager.stop_job") as mock_task:
                mock_result = MagicMock()
                mock_result.get.return_value = {
