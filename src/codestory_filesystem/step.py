            ...
            if result.ready():
                ...
                if result.successful():
                    try:
                        task_result = (
                            result.result
                        )  # Using result directly instead of blocking get()
    ...
    **config: Any,
    ...
    try:
        ...
        for current_dir, dirs, files in os.walk(repository_path):
            ...
            dir_summary = (
                f"Directory {rel_dir_path} completed in {dir_total_time:.2f}s: "
        ...
        try:
            ...
            record_props = {
                ...
                "performance": {
                    ...
                    "avg_neo4j_op_time": overall_timing_stats["neo4j_operations"][
                        "avg_operation_time"
                    ],
                },
            }
