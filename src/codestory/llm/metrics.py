...
def _get_or_create_counter(name: Any, description: Any, labels: Any=None) -> Any:[no-untyped-def]
    try:
...
def _get_or_create_gauge(name: Any, description: Any, labels: Any=None) -> Any:[no-untyped-def]
    try:
...
def _get_or_create_histogram(name: Any, description: Any, labels: Any=None, buckets: Any=None) -> Any:[no-untyped-def]
    try:
