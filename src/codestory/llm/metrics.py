...
def _get_or_create_counter(
    name: str, description: str, labels: Iterable[str] | None = None
) -> CounterLike:
...
def instrument_async_request(
    operation: OperationType,
) -> Callable[[Callable[P, Awaitable[R_async]]], Callable[P, Awaitable[R_async]]]:
    ...
    def decorator(
        func: Callable[P, Awaitable[R_async]]
    ) -> Callable[P, Awaitable[R_async]]:
        @functools.wraps(func)
