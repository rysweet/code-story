        ...
        try:
            ...
            try:
                ...
                if "unexpected keyword argument 'deployment_name'" in str(e):
                    ...
                    logger.debug("Falling back to standard OpenAI parameters (not using deployment_name)")
                    response = self._sync_client.completions.create(
                        model=model_name,
                        **request_data
                    )
            ...
            if not isinstance(e, OpenAIError):
                ...
                raise OpenAIError(f"Error generating completion: {str(e)}", cause=e) from e
            raise
        ...
        **kwargs: Any
        ...
        try:
            ...
            if not isinstance(e, OpenAIError):
                ...
                raise OpenAIError(f"Error generating chat completion: {str(e)}", cause=e) from e
            raise
        ...
        **kwargs: Any
        ...
        try:
            ...
            if not isinstance(e, OpenAIError):
                ...
                raise OpenAIError(f"Error generating embeddings: {str(e)}", cause=e) from e
            raise
