...
def config():
    ...
    Code Story uses a layered configuration system with the following sources (in order of precedence):
    
    1. Environment variables
    2. .env file - Contains bootstrap settings (connections, credentials)
    3. .codestory.toml - Contains application settings (managed by CLI)
    
    These commands manage the application settings in .codestory.toml.
    To modify bootstrap settings, edit the .env file directly.
    """
    pass
