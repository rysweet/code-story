...
class ConfigurationError(Exception):
    ...
    def __init__(
        self: Any, message: str, details: dict[str, Any] | None = None
    ) -> None:
...
class ValidationError(ConfigurationError):
    ...
    def __init__(
        self: Any, message: str, errors: list[dict[str, Any]] | None = None
    ) -> None:
...
class SettingNotFoundError(ConfigurationError):
    ...
    def __init__(
        self: Any, setting_path: str, available_settings: list[str] | None = None
    ) -> None:
