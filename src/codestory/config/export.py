...
def _redact_secrets(config_dict: Dict[str, Any], secret_fields: Optional[Set[str]] = None) -> Dict[str, Any]:
    ...
    for key, value in config_dict.items():
        if isinstance(value, dict):
            ...
            "password", "secret", "api_key", "token", "key", "client_secret", 
...
def settings_to_dict(settings: Optional[Settings] = None, redact_secrets: bool = True) -> Dict[str, Any]:
...
def create_env_template(
    ...
    lines.append(f"NEO4J__URI={settings.neo4j.uri}")
