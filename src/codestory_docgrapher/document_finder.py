...
class DocumentFinder:
    ...
    def find_documentation_files(self, ignore_patterns: Optional[List[str]] = None) -> List[DocumentationFile]:
                    ...
                    with open(absolute_path, "r", encoding="utf-8") as f:
                        ...
                        if "/**" in content and "*/" in content:
                            doc_file = DocumentationFile(
                                ...
                                metadata={
                                    "extension": file_extension,
                                    "source_type": "javascript" if file_extension == "js" else "typescript"
                                }
                            )
                            result.append(doc_file)
                except Exception as e:
