...
class LoginRequest(BaseModel):
    ...
    @classmethod
    def username_must_not_be_empty(cls: Any, v: str) -> str:
    ...
    @classmethod
    def password_must_not_be_empty(cls: Any, v: str) -> str:
...
class AuthResponse(BaseModel):
    ...
    user: UserInfo | None = Field(None, description='User information, if authentication was successful')
